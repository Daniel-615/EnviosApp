# Generated by Django 5.1.1 on 2024-10-05 21:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono_remitente', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='Número de teléfono inválido', regex='^\\+?[1-9]\\d{1,14}$')])),
                ('destinatario', models.CharField(max_length=30)),
                ('telefono_destinatario', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='Número de teléfono inválido', regex='^\\+?[1-9]\\d{1,14}$')])),
            ],
            options={
                'indexes': [models.Index(fields=['telefono_remitente'], name='envios_app__telefon_cd6fc4_idx'), models.Index(fields=['telefono_destinatario'], name='envios_app__telefon_cc86a3_idx')],
            },
        ),
        migrations.CreateModel(
            name='Envio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dpi_transportista', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(13), django.core.validators.MaxLengthValidator(15), django.core.validators.RegexValidator(message='El DPI debe contener solo números', regex='^\\d+$')])),
                ('licencia_transportista', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(8), django.core.validators.MaxLengthValidator(15)])),
                ('correo_transportista', models.EmailField(max_length=100)),
                ('telefono_transportista', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message='Número de teléfono inválido', regex='^\\+?[1-9]\\d{1,14}$')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_postal', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(message='El código postal debe contener solo números', regex='^\\d+$')])),
